...
class _PharmacistsPageState extends State<PharmacistsPage> {
  ...
  Widget _buildTopBookingsStrip() {
    ...
    return Padding(
      ...
      child: DecoratedBox(
      decoration: BoxDecoration(
          color: isDark ? shellBg : const Color(0xFFF0FAF4),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
            color: isDark
            ...
            children: [
                ...
                const SizedBox(height: 10),
                      ...
                      const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                        decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0xFFE8F5E9), Color(0xFFF4FBF6)],
                    ),
                    borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                      color: AppColors.primary.withValues(alpha: 0.2),
      ...
      clipBehavior: Clip.antiAlias,
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          children: [
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFFDFF0E4), Color(0xFFF0FAF3)],
              ),
            ),
            child: Row(
              children: [
...
class _PharmacistActionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final subColor =
        filled ? Colors.white.withValues(alpha: 0.88) : const Color(0xFF6B7280);
      ...
      child: InkWell(
        ...
        child: Container(
            ...
            gradient: filled
                ...
                : const LinearGradient(
                    colors: [Color(0xFFE8F5E9), Color(0xFFF8FCF9)],
                  ),
            border: filled
                ? null
                : Border.all(
