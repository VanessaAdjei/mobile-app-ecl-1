...
class _PaymentOrderItemsSectionState extends State<PaymentOrderItemsSection> {
  ...
  static const int _collapsedItemCount = 2;
    ...
    final content = Column(
      ...
      children: [
        ...
        if (selectedItems.isEmpty) ...[
          ...
          SizedBox(height: widget.embedded ? 8 : 10),
          ...selectedItems
              .take(_showAllItems ? selectedItems.length : _collapsedItemCount)
              .toList()
              .asMap()
              .entries
              .map((entry) {
            ...
            final isLast = index ==
                (selectedItems.length > _collapsedItemCount && !_showAllItems
                    ? _collapsedItemCount - 1
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: accent.border?.withValues(alpha: 0.45) ?? t.border,
                    ),
                  ),
                  child: ClipRRect(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: accent.border?.withValues(alpha: 0.4) ??
                                    t.border,
                              ),
                            ),
                            child: Text(
          ...
          if (selectedItems.length > _collapsedItemCount)
            Padding(
              padding: const EdgeInsets.only(top: 8),
              child: _ExpandToggle(
                label: _showAllItems
                    ? 'Show less'
                    : 'View ${selectedItems.length - _collapsedItemCount} more',
